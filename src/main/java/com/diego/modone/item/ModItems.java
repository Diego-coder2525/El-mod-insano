...
public class ModItems {
    public static final RegistryObject<Item> COPPER_INGOT =
            Registration.ITEMS.register("copper_ingot",
                    () -> new Item(new Item.Properties().group(modone.COURSE_TAB)));
    ...
    public enum ModArmorMaterial implements IArmorMaterial{
        COPPER(200, new int[]{2,7,5,3}, 10,
                SoundEvents.ITEM_ARMOR_EQUIP_IRON,
                Ingredient.fromStacks(new ItemStack(ModItems.COPPER_INGOT.get())), modone.MOD_ID+":copper", 0, 0.1f);
        ...
        ModArmorMaterial(int durability, int[] damageReductionArray, int enchantability, SoundEvent soundEvent, Ingredient repairMaterial, String name, float toughness, float knockbackResistance) {
