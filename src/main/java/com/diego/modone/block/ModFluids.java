...
public class ModFluids {
    ...
    public static final ResourceLocation OIL_STILL_RL = new ResourceLocation(modone.MOD_ID,
            "block/oil_still");
    public static final ResourceLocation OIL_FLOWING_RL = new ResourceLocation(modone.MOD_ID,
            "block/oil_flowing");
    public static final ResourceLocation OIL_OVERLAY_RL = new ResourceLocation(modone.MOD_ID,
            "block/oil_overlay");
    ...
    public static final ForgeFlowingFluid.Properties OIL_PROPERTIES =
            new ForgeFlowingFluid.Properties(() -> OIL_FLUID.get(),
                    () -> OIL_FLOWING.get(), FluidAttributes.builder(OIL_STILL_RL,OIL_FLOWING_RL)
                    .density(15).luminosity(2).rarity(Rarity.RARE).sound(SoundEvents.ITEM_HONEY_BOTTLE_DRINK).overlay(OIL_OVERLAY_RL)
                    .viscosity(5)).slopeFindDistance(3).levelDecreasePerBlock(3).block(
                            ()->ModFluids.OIL_BLOCK.get()).bucket(()-> ModItems.OIL_BUCKET.get());
    public static final RegistryObject<FlowingFluidBlock> OIL_BLOCK = Registration.BLOCKS.register("oil",
            () -> new FlowingFluidBlock(()-> ModFluids.OIL_FLUID.get(),
